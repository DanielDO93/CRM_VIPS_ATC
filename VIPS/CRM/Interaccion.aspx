                    ...
                    <div id="nuevo_pedido" runat="server" visible="false">
                        ...
                        <div class="form_default" style="margin-left: -20px;">
                            <ul>
                                ...
                                <li>
                                    <asp:TextBox ID="TextBox27" runat="server" CssClass="textbox validate[required]" Width="350px" value="¿Qué platillos contiene la órden?" onfocus="if (this.value=='¿Qué platillos contiene la órden?') this.value =''" onblur="if this.value=='') this.value ='¿Qué platillos contiene la órden?';" AutoPostBack="true"></asp:TextBox>
                                </li>
                    ...
                    <div id="cancelarPedido" runat="server" visible="false">
                        ...
                        <div class="form_default">
                            <ul>
                                ...
                                <li>
                                    <asp:TextBox ID="TextBox30" runat="server" CssClass="textbox validate[required]" AutoPostBack="true" TextMode="Number"></asp:TextBox></a></li>
                                &nbsp;
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    <asp:DropDownList ID="DropDownList14" runat="server" CssClass="textbox validate[required]">
                        ...
                        <asp:ListItem Value="4">Restaurante</asp:ListItem>
			<asp:ListItem Value="5">RAPPI</asp:ListItem>
			<asp:ListItem Value="6">Uber</asp:ListItem>
			<asp:ListItem Value="7">Sin delantal</asp:ListItem>
